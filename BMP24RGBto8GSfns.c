...
uint32_t get_header_value(char field[], uint8_t header[54]){
    ...
    while(1){
        ...
        if(strcmp(field, "BMPdata_offset") == 0){
            val = header[10];
            val |= header[11] << 8;
            val |= header[12] << 8;
            val |= header[13] << 8;
        ...
        if(strcmp(field, "BMPbitmap_width") == 0){
            val = header[18];
            val |= header[19] << 8;
            val |= header[20] << 8;
            val |= header[21] << 8;
        ...
        if(strcmp(field, "BMPbitmap_height") == 0){
            val = header[22];
            val |= header[23] << 8;
            val |= header[24] << 8;
            val |= header[25] << 8;
        ...
        if(strcmp(field, "BMPnum_colorplanes") == 0){
            val = header[26];
            val |= header[27] << 8;
            break;
        }
        if(strcmp(field, "BMPbits_per_pixel") == 0){
            val = header[28];
            val |= header[29] << 8;
            break;
        }
        if(strcmp(field, "BMPcompression_mode") == 0){
            val = header[30];
            val |= header[31] << 8;
            val |= header[32] << 8;
            val |= header[33] << 8;
        ...
        if(strcmp(field, "BMPpixeldata_size") == 0){
            val = header[34];
            val |= header[35] << 8;
            val |= header[36] << 8;
            val |= header[37] << 8;
        ...
        if(strcmp(field, "BMPpixels_per_meter_horizontal") == 0){
            val = header[38];
            val |= header[39] << 8;
            val |= header[40] << 8;
            val |= header[41] << 8;
        ...
        if(strcmp(field, "BMPpixels_per_meter_vertical") == 0){
            val = header[42];
            val |= header[43] << 8;
            val |= header[44] << 8;
            val |= header[45] << 8;
        ...
        if(strcmp(field, "BMPnumber_color_used") == 0){
            val = header[46];
            val |= header[47] << 8;
            val |= header[48] << 8;
            val |= header[49] << 8;
        ...
        if(strcmp(field, "BMPnumber_important_colors") == 0){
            val = header[50];
            val |= header[51] << 8;
            val |= header[52] << 8;
            val |= header[53] << 8;
